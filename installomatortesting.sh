...
LOGO="/Users/Shared/Management/Images/DHS.png"
# options:
            ...
            if pgrep -xq "$x"; then
                ...
                case $BLOCKING_PROCESS_ACTION in
                    ...
                    prompt_user|prompt_user_then_kill)
                      button=$(displaydialog "A new version of $x is available. $x must be quit to complete the update.\n\n$x will automatically be reopened once the update is complete.\n\n(Select Not Now if you would like to update at a later time)" "$x requires an update")
